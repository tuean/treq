...
pub fn tr(locale: Locale, key: &str) -> &'static str {
    match (locale, key) {
        ...
        (Locale::Zh, "settings.editor_line_h.hint") => "请求体 JSON、Docs、Query/Headers 表格、响应正文与各内容列表统一用这个值；范围 12–32，改完立刻生效",
        ...
        (Locale::En, "settings.editor_line_h.hint") => "One value for body JSON, docs, Query/Headers tables, response body and content lists · 12–32 · applies instantly",
